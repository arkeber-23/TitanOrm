<?php
namespace Cabez\TitanOrm\Kernel\Database\Builder;

use Cabez\TitanOrm\Kernel\Database\Connection;
use PDO;

use Cabez\TitanOrm\Kernel\Database\Interfaces\IBuilder as InterfacesIBuilder;

use PDOException;

class Builder implements InterfacesIBuilder
{
    private $connection;
    private $query;
    private $bindings = [];
